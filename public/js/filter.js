...
async function applyFilters() {
    ...
    //Nota: trate de hacerlo de una forma mas prolija haciendo un fetch y luego un render
    //de index pero no pude hacer que se renderice la vista con los filtros aplicados
